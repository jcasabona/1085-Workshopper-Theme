...
*/ 
function swpt_widget_shortcode_output($testimonials, $order, $order_by){ 
    global $post; 
    global $wpdb;
    ob_start();

    $strTbl = $wpdb->prefix."swp_testimonial";
    $strTestimonial = "SELECT id,description,company,website FROM $strTbl ORDER BY ". $order_by ." ". $order." LIMIT ".$testimonials;
